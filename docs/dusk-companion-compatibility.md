...
| Dusk base review head | `3ca993be235c59ebb2ce84ac8a7401102ab0fcc8` | Tested code plus the authoritative decision, immutable-evidence hygiene, proposal validation, and readiness-policy record |
...
| Stacked withdrawal review head | `0bf477b2a50a918d56c80aaf074ef711e6c0915b` | Tested stack plus the synchronized base decision, proposal validation, and immutable-evidence hygiene record |
| Review-policy boundary anchor | `dad14dbbea4bbd59f6c6697f89cc245d5c1cf2a0` | Adds the validator fail-stop source files to the fork boundary; reproduced locally and accepted by the hosted policy job without relabeling the static runtime checkout |
